...
<table width="100%" border="0" cellpadding="0" cellspacing="0" background="skin/images/frame/topbg.gif">
  <tr>
    <td width='40%' height="60"><font style="font-size:14px">亚格斯网站后台管理系统</font></td>
    <td width='60%' align="right" valign="bottom">
    	<table width="750" border="0" cellspacing="0" cellpadding="0">
      <tr>
      <td align="right" height="26" style="padding-right:10px;line-height:26px;">
        	您好：admin，欢迎使用亚格斯网站后台管理系统！
        	[<a href="../index.jsp" target="_blank">网站主页</a>]
        	[<a href="<%=path %>/manage/admin/adminInfo.jsp" target="main">修改密码</a>]
        	[<a href="<%=path %>/manage/admin/logout.jsp" target="_top" >注销退出</a>]&nbsp;
      </td>
      </tr>
